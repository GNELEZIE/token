...
if(isset($_SESSION['usermeetmee'])){
    ...
    $liste = $certificate->getCertificateAll();

    while($data = $liste->fetch()) {
        if($data['etat'] == 0){
            $btn = '
            <a class="dropdown-item" href="javascript:void(0)" style="color: #008000" onclick="valider('.$data['id_certificate'].')"><i class="mdi mdi-check-decagram mr-2 vertical-middle"></i>Valider</a>
            <a class="dropdown-item" href="javascript:void(0)" style="color: #ff0000" onclick="rejeter('.$data['id_certificate'].')"><i class="mdi mdi-block-helper mr-2 vertical-middle" style="font-size: 13px"></i>Rejeter</a>
            ';
        }else{
            $btn = '';
        }
               ...
               <td>
                   <div class="btn-group dropdown">
                       ...
                       <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end">
                           <a class="dropdown-item" href="media/identification/'.$data['doc'].'" style="color: darkorange" target="_blank"><i class="mdi mdi-arrow-down-circle-outline mr-2 vertical-middle"></i>Télécharger</a>
        ...
        $arr_list['data'][] = array(
            ...
            html_entity_decode(stripslashes($data['pseudo'])),
            $type,
