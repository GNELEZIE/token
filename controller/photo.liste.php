...
if(isset($_SESSION['usermeetmee'])){
    ...
    $liste = $fichier->getFichierByTypeUser($_SESSION['usermeetmee']['id_utilisateur'],0);

    while($data = $liste->fetch()) {
        if($data['nom_fichier'] != ''){
            $data_list .= '
                    <div class="col-md-4 mb-3 mytrash">
                        <a href="javascript:void(0)" class="supimg" onclick="supPhoto('.$data['id_fichier'].')" title="Supprimer"><i class="fa fa-trash" aria-hidden="true"></i></a>
...
$data_list .= '
        <div class="col-md-4 mb-3 loaderPhoto" style="display: none">
        ...
        <div class="col-md-4 mb-3">
            <a href="javascript:void(0)" onclick="ajoutPhoto()" title="Ajouter des photos">
