            ...
            <div class="row align-items-center flex-row-reverse gutter-vr-30px">
                <div class="col-lg-5">
                    <div class="gfx py-4 mx-auto mx-lg-0">
                        <img src="<?=$domaine?>/assets/images/salvia/gfx-i.png" alt="gfx">
                    </div>
                </div><!-- .col -->
                <div class="col-lg-7">
                    <!-- Section Head @s -->
                    <div class="nk-block-text pdb-r">
                        <h2 class="title title-thin">About ICO Crypto</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.</p>
                        <p>Deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.</p>
                    </div><!-- .section-head @e -->
    ...
    <div class="container">
        ...
        <div class="nk-block nk-block-features-s2">
            <div class="row align-items-center gutter-vr-30px">
                <div class="col-lg-6">
                    <div class="gfx py-4 mx-auto mx-lg-0">
                        <img src="<?=$domaine?>/assets/images/salvia/gfx-j.png" alt="gfx">
                    </div>
                </div><!-- .col -->
                <div class="col-lg-6">
                    <div class="feature">
    ...
    <div class="container">
        ...
        <div class="nk-block nk-block-features-s3">
            <div class="section-head section-head-s7 wide-auto-sm text-center">
                <h2 class="title title-thin">Problems</h2>
                <p class="lead">On the global marketplace</p>
            </div>
        ...
        <div class="nk-block nk-block-features-s3">
            <div class="section-head section-head-s7 wide-auto-sm text-center">
                <h2 class="title title-thin">Solutions</h2>
                <p class="lead">Our method and vision</p>
            </div>
            <div class="row justify-content-center gutter-vr-30px">
                <div class="col-lg-4 col-md-6">
                    <div class="feature feature-s3 feature-center">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col">
                    <div class="nk-block-text">
                        <h3 class="fw-3  pb-2"><span class="h1 fw-3 pb-3 d-block">The main issue</span> of decentralizing decision-making  and transparency and reliability</h3>
                        <p class="lead-s2">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum <br class="d-none d-lg-block"> deleniti atque corrupti quos dolores et quas molestias.</p>
                    </div><!-- .nk-block @e -->
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .block @e -->
...
<section class="section bg-white ov-h text-center" id="works">
    <div class="section-head section-head-s7 wide-auto-xs">
        <h2 class="title title-thin">How it works</h2>
        <p class="lead">Our Ecosystem based on blockchain and we solved issues of current and future</p>
    </div>
    <div class="container">
        <!-- Block @s -->
        <div class="nk-block nk-block-text-wrap">
    ...
    <div class="container">
        ...
        <div class="nk-block nk-block-features-s2">
            <div class="row align-items-center flex-row-reverse justify-content-between gutter-vr-30px">
                <div class="col-lg-7">
                    <div class="gfx gfx-auto mb-lg-3">
                        <img src="<?=$domaine?>/assets/images/app-screens/sc-large-k.png" alt="gfx">
                    </div>
                </div><!-- .col -->
                <div class="col-lg-4">
                    <!-- Section Head @s -->
                    <div class="section-head pb-lg-0">
                        <h2 class="title title-thin">Introducing ICO Usercenter</h2>
                        <p>First of we release our major update with usercenter design which is most important part of ICO Token Sales management. It allows to manage whole process of tokens sales.</p>
                    </div><!-- .section-head @e -->
                </div><!-- .col -->
            </div><!-- .row -->
            <div class="row features-list flex-wrap gutter-vr-30px">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="feature feature-s1 feature-s1-2 boxed boxed-xs bg-white bordered">
                        <div class="feature-icon feature-icon-s5 feature-icon-s5-2">
                            <em class="icon fas fa-check"></em>
                        </div>
                        <div class="feature-text feature-text-s1">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="feature feature-s1 feature-s1-3 boxed boxed-xs bg-white bordered">
                        <div class="feature-icon feature-icon-s5 feature-icon-s5-3">
                            <em class="icon fas fa-check"></em>
                        </div>
                        <div class="feature-text feature-text-s1">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="feature feature-s1 feature-s1-4 boxed boxed-xs bg-white bordered">
                        <div class="feature-icon feature-icon-s5 feature-icon-s5-4">
                            <em class="icon fas fa-check"></em>
                        </div>
                        <div class="feature-text feature-text-s1">
    ...
    <div class="section section-tokendes tc-light">
        <div class="container">
            <div class="section-head section-head-s7 text-center wide-auto-sm">
                <h2 class="title title-thin">ICO Crypto <br>Token Economics</h2>
                <p class="lead">Our initial coin offering will run till softcap reached.Full details of the ICO can be found within the platform.</p>
            </div><!-- .section-head @e -->
            <!-- .block @s -->
            <div class="nk-block">
            ...
            <div class="nk-block">
                <div class="token-box-bottom">
                    <div class="section-head section-head-s7 text-center wide-auto-sm">
                        <h2 class="title title-thin">Bonus Details</h2>
                    </div><!-- .section-head @e -->
                    <div class="row justify-content-center">
                        <div class="col-xl-3 col-md-4">
                            <div class="token-bonus-item one">
                        ...
                        <div class="col-xl-3 col-md-4">
                            <div class="token-bonus-item two">
                        ...
                        <div class="col-xl-3 col-md-4">
                            <div class="token-bonus-item three">
                    ...
                    <div class="col-lg-6">
                        <div class="token-alocate-item">
                            <div class="token-alocate-graph">
                                <img src="<?=$domaine?>/assets/images/icon.png" alt="icon">
...
<section class="section bg-light" id="document">
    <div class="container">
        <!-- Block @s -->
        <div class="section-head section-head-s7 text-center wide-auto-sm">
            <h2 class="title title-thin">Documentation</h2>
            <p class="lead">Download the whitepaper and learn about ICO Token, the unique ICO Crypto approach and the team/advisors.</p>
        </div><!-- .section-head @e -->
        <div class="nk-block nk-block-features">
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="feature feature-document">
                        <div class="feature-document-img">
                            <img src="<?=$domaine?>/assets/images/salvia/docs-sm-a.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="feature feature-document">
                        <div class="feature-document-img">
                            <img src="<?=$domaine?>/assets/images/salvia/docs-sm-b.jpg" alt="">
                        </div>
                        <div class="feature-document-text">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="feature feature-document">
                        <div class="feature-document-img">
                            <img src="<?=$domaine?>/assets/images/salvia/docs-sm-c.jpg" alt="">
                        </div>
                        <div class="feature-document-text">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="feature feature-document">
                        <div class="feature-document-img">
                            <img src="<?=$domaine?>/assets/images/salvia/docs-sm-d.jpg" alt="">
                        </div>
                        <div class="feature-document-text">
...
<section class="section bg-theme ov-h text-center tc-light overlay-x">
    <div class="container">
        <div class="section-head section-head-s7 wide-auto-sm">
            <h2 class="title title-thin">Beta Products</h2>
            <p class="lead">ICO Backend is the ICO token sales management software,which helps you to lunch and mange your ICO.</p>
        </div>
        <!-- Block @s -->
        <div class="nk-block nk-block-text-wrap">
            <div class="row justify-content-center gutter-vr-30px">
                <div class="col-lg-5">
                    <a href="#" class="product-box">
                        ...
                        <div class="product-image"><img src="<?=$domaine?>/assets/imagesimages/products/c.jpg" alt="prdouct"></div>
                    </a>
                </div>
                <div class="col-lg-5">
                    <a href="#" class="product-box">
                        <h5 class="product-name">Admin DASHDOARD</h5>
                        <div class="product-image"><img src="<?=$domaine?>/assets/imagesimages/products/d.jpg" alt="prdouct"></div>
                    </a>
                </div>
            </div><!-- .row -->
        </div><!-- .block @e -->
...
<div class="col-lg-3 col-sm-6">
    <div class="team">
        <div class="team-photo team-photo-s2">
            ...
            <img src="<?=$domaine?>/assets/imagesimages/team/md-a-color.jpg" alt="team">
        ...
        <div class="row align-items-start">
            <div class="col-md-6">
                <div class="team-photo">
                    <img src="<?=$domaine?>/assets/imagesimages/team/a-color.jpg" alt="team">
                </div>
            </div><!-- .col  -->
            <div class="col-md-6">
...
<div class="col-lg-3 col-sm-6">
    <div class="team">
        <div class="team-photo team-photo-s2">
            ...
            <img src="<?=$domaine?>/assets/images/team/md-b-color.jpg" alt="team">
            <ul class="team-social">
                <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
            </ul>
    ...
    <div id="team-popup-2" class="team-popup mfp-hide">
        ...
        <div class="row align-items-start">
            <div class="col-md-6">
                <div class="team-photo">
                    <img src="<?=$domaine?>/assets/images/team/b-color.jpg" alt="team">
                </div>
            </div><!-- .col  -->
            <div class="col-md-6">
                <div class="team-popup-info pl-md-3">
...
<div class="col-lg-3 col-sm-6">
    <div class="team">
        <div class="team-photo team-photo-s2">
            ...
            <img src="<?=$domaine?>/assets/images/team/md-c-color.jpg" alt="team">
            <ul class="team-social">
                <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
            </ul>
    ...
    <div id="team-popup-3" class="team-popup mfp-hide">
        ...
        <div class="row align-items-start">
            <div class="col-md-6">
                <div class="team-photo">
                    <img src="<?=$domaine?>/assets/images/team/c-color.jpg" alt="team">
                </div>
            </div><!-- .col  -->
            <div class="col-md-6">
                <div class="team-popup-info pl-md-3">
...
<div class="col-lg-3 col-sm-6">
    <div class="team">
        <div class="team-photo team-photo-s2">
            ...
            <img src="<?=$domaine?>/assets/images/team/md-d-color.jpg" alt="team">
            <ul class="team-social">
                <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
            </ul>
    ...
    <div id="team-popup-4" class="team-popup mfp-hide">
        ...
        <div class="row align-items-start">
            <div class="col-md-6">
                <div class="team-photo">
                    <img src="<?=$domaine?>/assets/images/team/d-color.jpg" alt="team">
                </div>
            </div><!-- .col  -->
            <div class="col-md-6">
                <div class="team-popup-info pl-md-3">
...
<div class="nk-block nk-block-team-list">
    <div class="section-head section-head-sm section-head-s7 text-center wide-auto-sm">
        <h2 class="title-md title-thin">Board Advisor</h2>
    </div>
    <div class="row justify-content-center">
        <div class="col-lg-3 col-sm-6">
            <div class="team">
                <div class="team-photo team-photo-s2">
                    ...
                    <img src="<?=$domaine?>/assets/images/team/md-e-color.jpg" alt="team">
                    <ul class="team-social">
                        <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                        <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                    </ul>
            ...
            <div id="team-popup-5" class="team-popup mfp-hide">
                ...
                <div class="row align-items-start">
                    <div class="col-md-6">
                        <div class="team-photo">
                            <img src="<?=$domaine?>/assets/images/team/e-color.jpg" alt="team">
                        </div>
                    </div><!-- .col  -->
                    <div class="col-md-6">
                        <div class="team-popup-info pl-md-3">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="team">
                <div class="team-photo team-photo-s2">
                    ...
                    <img src="<?=$domaine?>/assets/images/team/md-f-color.jpg" alt="team">
                    <ul class="team-social">
                        <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                        <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                    </ul>
            ...
            <div id="team-popup-6" class="team-popup mfp-hide">
                ...
                <div class="row align-items-start">
                    <div class="col-md-6">
                        <div class="team-photo">
                            <img src="<?=$domaine?>/assets/images/team/f-color.jpg" alt="team">
                        </div>
                    </div><!-- .col  -->
                    <div class="col-md-6">
                        <div class="team-popup-info pl-md-3">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="team">
                <div class="team-photo team-photo-s2">
                    ...
                    <img src="<?=$domaine?>/assets/images/team/md-g-color.jpg" alt="team">
                    <ul class="team-social">
                        <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                        <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                    </ul>
            ...
            <div id="team-popup-7" class="team-popup mfp-hide">
                ...
                <div class="row align-items-start">
                    <div class="col-md-6">
                        <div class="team-photo">
                            <img src="<?=$domaine?>/assets/images/team/g-color.jpg" alt="team">
                        </div>
                    </div><!-- .col  -->
                    <div class="col-md-6">
                        <div class="team-popup-info pl-md-3">
        ...
        <div class="row justify-content-between gutter-vr-30px">
            <div class="col-lg-4">
                <div class="section-head section-head-s7 wide-auto-sm text-lg-left text-center">
                    <h2 class="title title-thin">FAQs</h2>
                    <p class="lead">Below we’ve provided a bit of ICO, ICO Token, cryptocurrencies, and few others common question answers. If you have any other questions, please get in touch via email.</p>
                </div>
            </div><!-- .col -->
            <div class="col-lg-7">
                <div class="accordion" id="faq-36">
    ...
    <div class="container">
        ...
        <div class="nk-block block-partners">
            <div class="section-head section-head-sm">
                <h6 class="title-md title-thin text-center">Our Partners</h6>
            </div>
            <ul class="partner-list flex-lg-nowrap mgb-m30">
                <li class="partner-logo-s3"><img src="<?=$domaine?>/assets/images/partners/a-xs.png" alt="partner"></li>
                <li class="partner-logo-s3"><img src="<?=$domaine?>/assets/images/partners/b-xs.png" alt="partner"></li>
                <li class="partner-logo-s3"><img src="<?=$domaine?>/assets/images/partners/c-xs.png" alt="partner"></li>
                <li class="partner-logo-s3"><img src="<?=$domaine?>/assets/images/partners/d-xs.png" alt="partner"></li>
                <li class="partner-logo-s3"><img src="<?=$domaine?>/assets/images/partners/e-xs.png" alt="partner"></li>
                <li class="partner-logo-s3"><img src="<?=$domaine?>/assets/images/partners/f-xs.png" alt="partner"></li>
            </ul>
        </div>
        <!-- Block @e -->
    </div>
